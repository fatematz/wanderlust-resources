...
const SignUp = () => {
  ...
  return (
    <div className="mt-[100px] mb-[60px] max-w-[1400px] flex flex-col items-center ">
      ...
      <Form
        onSubmit={onSubmit}
        className="flex w-[450px] mx-auto flex-col gap-5 bg-white p-10 rounded-xl shadow-sm border border-gray-100"
      >
        {/* Full Name Field */}
        ...
        <Button
          type="submit"
          className="w-full bg-[#17a2b8] text-white py-6 rounded-md hover:bg-[#138496] transition-colors mt-2"
        >
          Create Account
        </Button>
        ...
        <Button onClick={handleGoogleSignin}
          variant="bordered"
          className="w-full border-gray-200 py-6 text-gray-700 font-medium flex gap-2"
        >
        ...
        <p className="text-center text-gray-500 mt-4">
          ...
          <span className="text-[#17a2b8] font-semibold cursor-pointer">
            Sign In
          </span>
        </p>
      </Form>
